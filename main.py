...
bot = telebot.TeleBot('en', parse_mode=None)
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id,
                     text="Привет, {0.first_name}! Я помогу тебе быть в курсе расписания уроков, "
                          "маленький курильщик😉".format(message.from_user), reply_markup=markup)
